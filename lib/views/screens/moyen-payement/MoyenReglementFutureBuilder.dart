...
class MoyenReglementFutureBuilderState
  ...
  List<bool> moyenReglementStates = [];
  // init API instance
  Api api = Api();
                          ...
                          itemBuilder: (itemBuilderContext, index) {
                            return Container(
                              decoration: BoxDecoration(
                                color: (MoyenReglement.moyenReglement != null &&
                                        MoyenReglement.moyenReglement!.id ==
                              ...
                              child: ListTile(
                                ...
                                onLongPress: () {
                                  ...
                                  setState(() {
                                    ...
                                    if (MoyenReglement.moyenReglement != null &&
                                      ...
                                      // ? Reset all moyenReglementStates
                                      MoyenReglement.moyenReglement = null;
                                    } else {
                                      // When is not selected yet
                                      // ? Load MoyenReglement instance for deletion
                                ...
                                leading: CircleAvatar(
                                  ...
                                  child: MyText(
                                    ...
                                    color: (MoyenReglement.moyenReglement !=
                                                null &&
                                            MoyenReglement.moyenReglement!.id ==
                                                snapshot.data![index].id)
                                        ? Colors.white
