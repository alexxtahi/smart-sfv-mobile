...
import 'package:smartsfv/views/screens/parametres/client/ClientScreen.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          functions.showFormDialog(
            ...
            onValidate: () async {
              //functions.normalizePhoneNumber(fieldControllers['contact'].text); // ! debug
              if (formKey.currentState!.validate()) {
                ...
                final Map<String, dynamic> postClientResponse =
                  ...
                  client: Client.fromJson({
                    ...
                    'contact_client': (fieldControllers['pays'] == 51)
              ...
              Column(
                ...
                children: [
                  ...
                  /*MyPhoneNumberFormField(
                    controller: fieldControllers['contact'],
                    prefixPadding: 10,
                    prefixIcon: Icon(
